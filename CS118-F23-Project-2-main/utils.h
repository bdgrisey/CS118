...
void build_packet(struct packet* pkt, short seqnum, short acknum, char last, char ack,unsigned int length, const char* payload, long int position_before_reading, long int position_after_reading) {
    pkt->seqnum = seqnum;
    pkt->acknum = acknum;
    pkt->ack = ack;
    pkt->last = last;
